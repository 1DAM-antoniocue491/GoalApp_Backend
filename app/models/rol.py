...
class Rol(Base):
    ...
    usuario_roles = relationship("UsuarioRol", back_populates="rol", lazy="raise", foreign_keys="UsuarioRol.id_rol", overlaps="usuarios")
    usuarios = relationship("Usuario", secondary="usuario_rol", back_populates="roles", lazy="raise", overlaps="usuario_roles")
