...
- Fixtures para usuarios, roles, ligas, equipos, etc.
"""
import pytest
...
def db():
    ...
    Se crea y destruye después de cada test.
    """
...
def headers_admin(token_admin):
    """Headers con autorización Bearer para admin."""
...
def liga_configuracion_ejemplo(db, liga_ejemplo):
    """Crea una configuración de liga de prueba."""
